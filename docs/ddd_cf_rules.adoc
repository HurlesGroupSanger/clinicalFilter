...
Keep _synonymous_ and _UTR_ splicing variants with high predicted impact (spliceAI >= *0.8*). 
...
- "both missense" include any combination of _missense_ and _inframe_ variants
